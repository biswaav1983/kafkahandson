...
public class ConsumerApp {
    public static void main(String[] args){
        ...
        partitions.add(new TopicPartition("my-topic-1", 0));
        partitions.add(new TopicPartition("my-topic-1", 1)); // Adds a TopicPartition instance representing a topic and a partition.
        partitions.add(new TopicPartition("my-topic-1", 2)); // Adds an additional TopicPartition instance representing a different partition within the topic. Change as desired.
